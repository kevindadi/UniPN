...
Because they are two granularities of one thing, `ControlSub` names *roles*, not granularities. It has five variants and each is a distinction some analysis makes:
