...
fn build_semaphore_net() -> cvn::net::CvnNet {
    CvnNetBuilder::new()
        ...
        .add_transition("t_spawn_w3", TransitionKind::Spawn)
        ...
        .add_transition("t_w1_acq", TransitionKind::Lock)
        ...
        .add_transition("t_w1_rel", TransitionKind::Unlock)
        ...
        .add_transition("t_w2_acq", TransitionKind::Lock)
        ...
        .add_transition("t_w2_rel", TransitionKind::Unlock)
        ...
        .add_transition("t_w3_acq", TransitionKind::Lock)
        ...
        .add_transition("t_w3_rel", TransitionKind::Unlock)
