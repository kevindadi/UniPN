...
fn build_rwlock_net() -> cvn::net::CvnNet {
    ...
    CvnNetBuilder::new()
        ...
        .add_transition("t_spawn_r1", TransitionKind::Spawn)
        ...
        .add_transition("t_spawn_r2", TransitionKind::Spawn)
        ...
        .add_transition("t_spawn_wr", TransitionKind::Spawn)
        ...
        .add_transition("t_join_r1", TransitionKind::Join)
        ...
        .add_transition("t_join_r2", TransitionKind::Join)
        ...
        .add_transition("t_r1_read", TransitionKind::Lock)
        ...
        .add_transition("t_r1_drop", TransitionKind::Unlock)
        ...
        .add_transition("t_r2_read", TransitionKind::Lock)
        ...
        .add_transition("t_r2_drop", TransitionKind::Unlock)
        ...
        .add_transition("t_wr_lock", TransitionKind::Lock)
        ...
        .add_transition("t_wr_drop", TransitionKind::Unlock)
