...
fn build_mutex_deadlock_net() -> cvn::net::CvnNet {
    CvnNetBuilder::new()
        ...
        // --- Transitions ---
        // main: spawn w1
        .add_transition("t_spawn_w1", TransitionKind::Spawn, &["s0"])
        ...
        // main: spawn w2
        .add_transition("t_spawn_w2", TransitionKind::Spawn, &["s1"])
        ...
        // main: join w1
        .add_transition("t_join_w1", TransitionKind::Join, &["s2"])
        ...
        // main: join w2
        .add_transition("t_join_w2", TransitionKind::Join, &["s3"])
        ...
        // w1: lock(mtx_a)
        .add_transition("t_w1_lock_a", TransitionKind::Lock, &["w1s0"])
        ...
        // w1: lock(mtx_b)
        .add_transition("t_w1_lock_b", TransitionKind::Lock, &["w1s1"])
        ...
        // w1: drop(mtx_b)
        .add_transition("t_w1_drop_b", TransitionKind::Unlock, &["w1s2"])
        ...
        // w1: drop(mtx_a)
        .add_transition("t_w1_drop_a", TransitionKind::Unlock, &["w1s3"])
        ...
        // w2: lock(mtx_b)
        .add_transition("t_w2_lock_b", TransitionKind::Lock, &["w2s0"])
        ...
        // w2: lock(mtx_a)
        .add_transition("t_w2_lock_a", TransitionKind::Lock, &["w2s1"])
        ...
        // w2: drop(mtx_a)
        .add_transition("t_w2_drop_a", TransitionKind::Unlock, &["w2s2"])
        ...
        // w2: drop(mtx_b)
        .add_transition("t_w2_drop_b", TransitionKind::Unlock, &["w2s3"])
